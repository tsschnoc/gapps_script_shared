...
//    calendar.getAllCalendarsFeed('http://www.google.com/calendar/feeds/default/allcalendars/full', callback, callback);
  ...
  function insertSFToGcalEvent(sftimecard) {
      ...
      insEvent.start = {"dateTime": sftimecard.Date__c + "T" + sftimecard.TimeStart__c.substring(0, 2) + ":" + sftimecard.TimeStart__c.substring(2, 2) + ":00.000Z"};
      insEvent.end = {"dateTime": "2012-01-07T20:55:27.000Z"};
      insEvent.end = {"dateTime": sftimecard.Date__c + "T" + sftimecard.TimeStart__c.substring(0, 2) + ":" + sftimecard.TimeStart__c.substring(2, 2) + ":00.000Z"};
