...
// end: SF Oauth dane  
  ...
  function sf_queryCases() {
    ...
    var queryString = "Select Id, Name, Case__r.Id, Case__r.Subject, Case__r.Description, Case__r.Project__r.Name, Case__r.Project__r.Account__r.Name, CreatedDate  from TimeCard__c " + " WHERE Timekeeper__c = \'" + Timekeeper__c + "\' order by CreatedDate desc Limit 50";
    var callUrl = oauth2_identity.urls.rest + "query/?q=" + encodeURIComponent(queryString);
    //debug("!!!!!!!!!!!!!!!!!! callUrl :" + callUrl);
    var params = {};
    params[gadgets.io.RequestParameters.METHOD] = gadgets.io.MethodType.GET;
